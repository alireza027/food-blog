...
class Archive_Cooking extends React.Component{
  constructor(){
    super();
    this.state = {
                  ...
                  <div className="col-12">
                      <nav aria-label="breadcrumb">
                          <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Archive Cooking Page</li>
                          </ol>
                      </nav>
                  </div>
              </div>
...
export default Archive_Cooking;