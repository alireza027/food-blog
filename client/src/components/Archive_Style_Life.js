...
class Archive_Style_Life extends React.Component{
  constructor(){
    super();
    this.state = {
                  ...
                  <div className="col-12">
                      <nav aria-label="breadcrumb">
                          <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Archive Life Style Page</li>
                          </ol>
                      </nav>
                  </div>
              </div>
...
export default Archive_Style_Life;